...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'N_V0woXvxkTWOuZHZABBnmW0pwtXWbCh',
        ...
        'session' => [
            // this is the name of the session cookie used for login on the
        ...
        'errorHandler' => [
            'errorAction' => YII_SITE_TYPE . '/error/error',//site/error
        ],
